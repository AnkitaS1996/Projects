...
{
    public partial class Frm_Monthly_Stock_Reports : Form
    {
        public Frm_Monthly_Stock_Reports()
        {
            InitializeComponent();
        }

        private void Frm_Monthly_Stock_Reports_Load(object sender, EventArgs e)
        {
